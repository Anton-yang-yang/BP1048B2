...
C_SRCS += \
../app_src/components/soft_watchdog/soft_watch_dog.c 

OBJS += \
./app_src/components/soft_watchdog/soft_watch_dog.o 

C_DEPS += \
./app_src/components/soft_watchdog/soft_watch_dog.d 


# Each subdirectory must supply rules for building sources it contributes
app_src/components/soft_watchdog/%.o: ../app_src/components/soft_watchdog/%.c
	@echo 'Building file: $<'
